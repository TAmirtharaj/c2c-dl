...
const WhyShouldICare = (props) => {
  ...
  return (
    <div className='container-padding why-should-i-care-comp-container'>
...
export default connect(mapStateToProps, mapDispatchToProps)(WhyShouldICare);
